						...
						<div class="account-info">
							<div class="single-account-info">
								<ul>
									...
									<li><a href="#"><i class="fa fa-list-ol"></i><span>Đổi mật khẩu</span>	</a></li>
									<li><a href="#"><i class="fa fa-file-o"></i><span>Đổi ảnh đại điện</span>	</a></li>
									<li><a href="checkout-address.html"><i class="fa fa-building"></i><span>Tất cả các hóa đơn</span>	</a></li>
								</ul>
							</div>
						</div>
					</div>
