					...
					<div class="main-slider-area">
								...
								<div id="wrapper">
									<div class="slider-wrapper">
										<div id="mainSlider" class="nivoSlider">
											<img src="page_asset/img/slider/2.jpg" alt="main slider" title="#htmlcaption"/>
											<img src="page_asset/img/slider/1.jpg" alt="main slider" title="#htmlcaption2"/>
										</div>
						...
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
							<div class="slider-right zoom-img m-top">
								<a href="#"><img class="img-responsive" src="page_asset/img/product/cms11.jpg" alt="sidebar left" /></a>
							</div>
						</div>
						<!-- SLIDER-RIGHT END -->
					</div>
										...
										<div class="new-pro-carousel">
                                            ...
                                            <div class="item">
												<div class="new-product">
													<div class="single-product-item">
                                                        ...
                                                        <a href="#"><img src="storage/{{$pr->images}}" alt="product-image" /></a>
											...
											<div class="item">
												<div class="new-product">
													<div class="single-product-item">
														<div class="product-image">
															<a href="#"><img src="page_asset/img/product/sale/6.jpg" alt="product-image" /></a>
															<a href="#" class="new-mark-box">new</a>
															<div class="overlay-content">
																<ul>
																	<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
											...
											<div class="item">
												<div class="new-product">
													<div class="single-product-item">
														<div class="product-image">
															<a href="#"><img src="page_asset/img/product/sale/4.jpg" alt="product-image" /></a>
															<a href="#" class="new-mark-box">new</a>
															<div class="overlay-content">
																<ul>
																	<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
											...
											<div class="item">
												<div class="new-product">
													<div class="single-product-item">
														<div class="product-image">
															<a href="#"><img src="page_asset/img/product/sale/2.jpg" alt="product-image" /></a>
															<a href="#" class="new-mark-box">new</a>
															<div class="overlay-content">
																<ul>
																	<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
											...
											<div class="item">
												<div class="new-product">
													<div class="single-product-item">
														<div class="product-image">
															<a href="#"><img src="page_asset/img/product/sale/10.jpg" alt="product-image" /></a>
															<a href="#" class="new-mark-box">new</a>
															<div class="overlay-content">
																<ul>
																	<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
											...
											<div class="item">
												<div class="new-product">
													<div class="single-product-item">
														<div class="product-image">
															<a href="#"><img src="page_asset/img/product/sale/11.jpg" alt="product-image" /></a>
															<a href="#" class="new-mark-box">new</a>
															<div class="overlay-content">
																<ul>
																	<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
											...
											<div class="item">
												<div class="new-product">
													<div class="single-product-item">
														<div class="product-image">
															<a href="#"><img src="page_asset/img/product/sale/3.jpg" alt="product-image" /></a>
															<a href="#" class="new-mark-box">new</a>
															<div class="overlay-content">
																<ul>
																	<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
											...
											<div class="item">
												<div class="new-product">
													<div class="single-product-item">
														<div class="product-image">
															<a href="#"><img src="page_asset/img/product/sale/1.jpg" alt="product-image" /></a>
											...
											<div class="item">
												<div class="new-product">
													<div class="single-product-item">
														<div class="product-image">
															<a href="#"><img src="page_asset/img/product/sale/9.jpg" alt="product-image" /></a>
															<a href="#" class="new-mark-box">sale!</a>
															<div class="overlay-content">
																<ul>
																	<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
											...
											<div class="item">
												<div class="new-product">
													<div class="single-product-item">
														<div class="product-image">
															<a href="#"><img src="page_asset/img/product/sale/5.jpg" alt="product-image" /></a>
															<a href="#" class="new-mark-box">new</a>
															<div class="overlay-content">
																<ul>
																	<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
					...
					<div class="add-two-by-one-column">
						<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
							<div class="tow-column-add zoom-img">
								<a href="#"><img src="page_asset/img/product/shope-add1.jpg" alt="shope-add" /></a>
							</div>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<div class="one-column-add zoom-img">
								<a href="#"><img src="page_asset/img/product/shope-add2.jpg" alt="shope-add" /></a>
							</div>								
						</div>
					</div>
									...
									<div class="item">
										<div class="single-product-item">
											...
											<div class="product-info">
												...
												<a href="single-product.html" title="{{$pd->name}}">{{shorten_string($pd->name,5)}}</a>
												<div class="price-box">
                                                        @if($pd->discount > 0)
								...
								<div role="tabpanel" class="tab-pane active" id="women-tab">
									<div class="bg-tab-content-area tab-carousel-1">
										...
										<div class="item">
											<div class="single-product-item">
												<div class="product-image">
													<a href="#"><img src="page_asset/img/product/sale/12.jpg" alt="product-image" /></a>
													<a href="#" class="new-mark-box">new</a>
													<div class="overlay-content">
														<ul>
															<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
										...
										<div class="item">
											<div class="single-product-item">
												<div class="product-image">
													<a href="#"><img src="page_asset/img/product/sale/13.jpg" alt="product-image" /></a>
													<a href="#" class="new-mark-box">new</a>
													<div class="overlay-content">
														<ul>
															<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
										...
										<div class="item">
											<div class="single-product-item">
												<div class="product-image">
													<a href="#"><img src="page_asset/img/product/sale/7.jpg" alt="product-image" /></a>
													<a href="#" class="new-mark-box">new</a>
													<div class="overlay-content">
														<ul>
															<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
										...
										<div class="item">
											<div class="single-product-item">
												<div class="product-image">
													<a href="#"><img src="page_asset/img/product/sale/8.jpg" alt="product-image" /></a>
													<a href="#" class="new-mark-box">new</a>
													<div class="overlay-content">
														<ul>
															<li><a href="#" title="Quick view"><i class="fa fa-search"></i></a></li>
								...
								<div class="bestseller-carousel">
									...
									<div class="item">
										<div class="single-product-item">
                                            ...
                                            <a href="single-product.html">{{shorten_string($ph->name,5)}}</a>
												<div class="price-box">
                                                <span class="price">{{number_format($ph->price)}}</span>
													<span class="old-price">$27.00</span>
												</div>
											</div>
										</div>							
					...
					<div class="image-add-area">
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							...
							<div class="onehalf-add-shope zoom-img">
								<a href="#"><img src="page_asset/img/product/one-helf1.jpg" alt="shope-add" /></a>
							</div>
							<!-- ONEHALF-ADD END -->
						</div>
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<!-- ONEHALF-ADD START -->
							<div class="onehalf-add-shope zoom-img">
								<a href="#"><img src="page_asset/img/product/one-helf2.jpg" alt="shope-add" /></a>
							</div>
							<!-- ONEHALF-ADD END -->
						</div>						
					</div>
							...
							<div class="row">
								...
								<div class="latest-news-carousel">
									...
									<div class="item">
										<div class="latest-news-post">
											<div class="single-latest-post">
												<a href="#"><img src="page_asset/img/latest-news/1.jpg" alt="latest-post" /></a>
									...
									<div class="item">
										<div class="latest-news-post">
											<div class="single-latest-post">
												<a href="#"><img src="page_asset/img/latest-news/2.jpg" alt="latest-post" /></a>
									...
									<div class="item">
										<div class="latest-news-post">
											<div class="single-latest-post">
												<a href="#"><img src="page_asset/img/latest-news/3.jpg" alt="latest-post" /></a>
									...
									<div class="item">
										<div class="latest-news-post">
											<div class="single-latest-post">
												<a href="#"><img src="page_asset/img/latest-news/4.jpg" alt="latest-post" /></a>
									...
									<div class="item">
										<div class="latest-news-post">
											<div class="single-latest-post">
												<a href="#"><img src="page_asset/img/latest-news/5.jpg" alt="latest-post" /></a>
									...
									<div class="item">
										<div class="latest-news-post">
											<div class="single-latest-post">
												<a href="#"><img src="page_asset/img/latest-news/6.jpg" alt="latest-post" /></a>
								...
								<div class="client-carousel">
									...
									<div class="item">
										<div class="single-client">
											<a href="#">
												<img src="page_asset/img/brand/1.png" alt="brand-client" />
											</a>
										</div>									
									</div>
									<!-- CLIENT-SINGLE END -->
									...
									<div class="item">
										<div class="single-client">
											<a href="#">
												<img src="page_asset/img/brand/2.png" alt="brand-client" />
											</a>
										</div>									
									</div>
									<!-- CLIENT-SINGLE END -->
									...
									<div class="item">
										<div class="single-client">
											<a href="#">
												<img src="page_asset/img/brand/3.png" alt="brand-client" />
											</a>
										</div>									
									</div>
									<!-- CLIENT-SINGLE END -->
									...
									<div class="item">
										<div class="single-client">
											<a href="#">
												<img src="page_asset/img/brand/4.png" alt="brand-client" />
											</a>
										</div>									
									</div>
									<!-- CLIENT-SINGLE END -->
									...
									<div class="item">
										<div class="single-client">
											<a href="#">
												<img src="page_asset/img/brand/5.png" alt="brand-client" />
											</a>
										</div>									
									</div>
									<!-- CLIENT-SINGLE END -->
